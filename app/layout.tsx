...
const SERVICE_NAME = "Handmade Label Checker";
const SERVICE_DESCRIPTION =
  "Free label checklists for handmade soap, cosmetics, and candles — true-soap-vs-cosmetic classification and sourced FDA/CPSC label element checklists for small sellers.";
